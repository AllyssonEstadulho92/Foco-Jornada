...
**Estado:** aceite, integrada no PR #211 e publicada.

**Decisão:** implementar o protótipo aprovado na rota `#/ferias` com filtros efémeros (1–30 dias úteis, mês a evitar, critério juntar fins de semana/mais cedo/maior saldo). Gerar candidatos apenas futuros, até dezembro, sem atravessar mês excluído ou sobrepor dia útil já registado. Reutilizar `simulateVacationPeriod` para validar cálculo e saldo; só sugerir candidatos com saldos pessoais previstos não negativos no fim e no fim do ano. Escolher um candidato por mês de início, mantendo alternativas diferentes e calendário contextual. O botão de sugestão apenas preenche o simulador existente; não cria férias nem escreve preferências no cofre.

**Motivo:** permitir comparação de datas/meses reais, descanso potencial e impacto no saldo sem tratar as datas ilustrativas de 2025 como atuais nem confundir meta pessoal 28 com direito legal ou aprovação. Ordenação transparente por critérios escolhidos; não é avaliação objetiva de destino, preços ou conveniência profissional.

**Limites e riscos:** a regra padrão segunda–sexta não identifica feriados, escala, ausências, disponibilidade de colegas, custos, CCT ou consentimento do empregador. Descanso potencial inclui fins de semana adjacentes apenas se forem dias de descanso na escala. Validação física no iPhone ainda pendente. Sem nova tabela, schema, endpoint, permissão, token, telemetria ou dependência. CSS isolado e controlos acessíveis com `forced-colors`/`prefers-reduced-motion`.

**Entrega:** Qualidade #1150 e #1156 no head, Qualidade após merge em `main` (run `35127380594`), Publicar #250 e Pages #819 passaram; merge `b687673a467cf5fc5061160b41a254e4b55118cc`, build `271035a552cb6a1ecdbfe6ee8032bcafed7013ff`.
