...
**Estado:** aceite, PR #216 integrado/publicado. Checklist temporária declarativa da parceira/empregador; trocar dados, filtros ou datas repõe vistos por identidade do cenário. Não envia API nem marca férias automaticamente.
...
**Estado:** aceite, PR #218 integrado/publicado. `href="#vacation-evidence-title"` substituía rota `#/ferias` e originava 404 no iPhone. Botão com `focusSection`, foco em título `tabIndex={-1}` e rota residual `*` com recuperação PT-PT. Skip link global corrigido no PR #220. **Entrega:** merge `89564f3ebbfe5d54e5d09dcf28db9e574b35cc50`, Qualidade #1201/#1202, Publicar #257, Pages #848, build `42397a6c97d60044f5dbc1cf90723ee799b1d0ac`.
