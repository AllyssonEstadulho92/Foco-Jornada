...
test('compatibilidades restantes estão ligadas a ações reais',()=>{
  for(const fn of ['testNotification','handleImportFile','resetAllData','closeDailySummary','openMoovitPlanner','planMoovit','nearbyMoovit','sharePlannerIcs','printPlannerA4','checkForAppUpdate'])assert.ok(runtime.includes(`function ${fn}`),fn);
});
