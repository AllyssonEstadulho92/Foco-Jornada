const CACHE='foco-jornada-v4-2-0-linear-planning2';
const ASSETS=[
  './','./index.html',
  ...
  './core.js','./productivity-core.js','./focus-mode-core.js','./focus-mode.js','./planning-mode.js','./persistence.js','./boot-recovery.js','./install-app.js','./app.js','./stability.js','./ux.js',
