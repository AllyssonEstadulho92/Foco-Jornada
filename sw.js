const CACHE='foco-jornada-v4-2-0-hub';
const ASSETS=['./','./index.html','./styles.css','./ux.css','./features.css','./hub.css','./core.js','./app.js','./stability.js','./ux.js','./features-core.js','./features.js','./hub.js','./manifest.webmanifest','./icon.svg','./.nojekyll'];
